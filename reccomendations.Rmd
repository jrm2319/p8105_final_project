...
output_path <- "C:/Users/jacks/OneDrive/Documents/p8105_final_project/reccomendations.html"

render("reccomendations.Rmd", output_file = output_path)
=======
output_path <- "./reccomendations.html"

# Render the document with the specified output file path
render("reccomendations.Rmd", output_file = output_path)
